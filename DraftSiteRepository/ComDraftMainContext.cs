...
{
    public partial class ComDraftMainContext : DbContext
    {
        public ComDraftMainContext()
        {
        }

        public ComDraftMainContext(DbContextOptions<ComDraftMainContext> options)
            : base(options)
        {
        }

        protected ComDraftMainContext(DbContextOptions options) : base(options) { }

        #region DraftSite Database
