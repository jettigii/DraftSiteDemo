...
namespace DraftSiteRepository
{
    public partial class DraftSiteContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            MultiPlayerDraftOnModelBuilding(modelBuilder);
        ...
        public void MultiPlayerDraftOnModelBuilding(ModelBuilder modelBuilder)
        {
            ConfigurePrimaryKeys(modelBuilder);

            ConfigureForeignKeys(modelBuilder);

            SeedDraftTimeData(modelBuilder);
        ...
        private void SeedDraftTimeData(ModelBuilder modelBuilder)
        {
